...
public class UpdatVersionActivity extends AppCompatActivity {
    ...
    String url = "http://192.168.0.105/server/getUser.php";
    ...
    private void getInfomationUser(String url){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(UpdatVersionActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }
        ){
            @Override
